...
//used for analysis purposes
	...
	{
		//ar & BOOST_SERIALIZATION_NVP(dominationList);
		//ar & BOOST_SERIALIZATION_NVP(dominationcount);
		//ar & BOOST_SERIALIZATION_NVP(rank);
		//ar & BOOST_SERIALIZATION_NVP(ranked);
		//ar & BOOST_SERIALIZATION_NVP(competition);
		//ar & BOOST_SERIALIZATION_NVP(generation);
		//ar & BOOST_SERIALIZATION_NVP(secondary);
		ar & BOOST_SERIALIZATION_NVP(fitness);
		//ar & BOOST_SERIALIZATION_NVP(novelty);
		//ar & BOOST_SERIALIZATION_NVP(novelty_scale);
		//ar & BOOST_SERIALIZATION_NVP(age);
		ar & BOOST_SERIALIZATION_NVP(data);
		ar & BOOST_SERIALIZATION_NVP(phenotype);
		ar & BOOST_SERIALIZATION_NVP(genotype);
		//ar & BOOST_SERIALIZATION_NVP(indiv_number);
		//ar & BOOST_SERIALIZATION_NVP(viable);
		//ar & BOOST_SERIALIZATION_NVP(added);
...
public:
    ...
    noveltyarchive(float threshold,float (*nm)(noveltyitem*,noveltyitem*),bool rec=true,int pbs=-1,bool mc=false,bool _generational=false)
    {
        ...
        neighbors=15; //tested with 4, lead to slightly more evolvability...
        localneighbors=15; 
...
public:
	...
	//type * _par;
	BipedEvo(){}
	//Evo(type & org) : _org(org){}
	void print(type & org) const {
