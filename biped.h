...
void evolvability_biped(Organism* org,char* fn,bool recall=false);
...
void biped_evaluate_paralell(NEAT::Organism* org,data_record* data=NULL);
dReal evaluate_controller(Controller* controller,noveltyitem* ni=NULL,data_record* record=NULL,bool log=false, bool off=false);
...
static dReal FOOTX_SZ =0.5/SCALE_FACTOR;//Henok was 1.0
static dReal FOOTY_SZ =0.5/SCALE_FACTOR;
static dReal FOOTZ_SZ =0.5/SCALE_FACTOR;//Henok was 1.0
static dReal LLEG_LEN =1.0/SCALE_FACTOR;
static dReal LLEG_RAD =0.2;// Henok was 0.2/SCALE_FACTOR;
static dReal ULEG_LEN =1.0/SCALE_FACTOR;
static dReal ULEG_RAD =0.2;//Henok was 0.2/SCALE_FACTOR;
...
static dReal FOOT_DENSITY=1.0;//Henok was 0.1
...
public:
    ...
    virtual dReal fitness()
    {
        ...
        for (int x=0; x<2; x++)
        {
            //cout<<new_com[x]<<" "<<orig_com[x]<<endl;
